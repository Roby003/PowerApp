...
const betweenLength = (length) => (value) => minLength(value, length) && maxLength(value, length);
...
const isAlphanumeric = (value) => isNumeric(value) && isLowercase(value) && isUppercase(value);
